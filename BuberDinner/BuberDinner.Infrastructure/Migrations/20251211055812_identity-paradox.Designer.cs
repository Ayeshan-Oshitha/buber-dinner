...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20251211055812_identity-paradox")]
    partial class identityparadox
    {
            ...
            modelBuilder.Entity("BuberDinner.Domain.MenuAggregate.Menu", b =>
                {
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuAggregate.Entites.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("BuberDinner.Domain.MenuAggregate.Entites.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
